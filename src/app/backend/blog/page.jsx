...
const Blog = () => {
    ...
    const callData = () => {
        axios.get(`${process.env.NEXT_PUBLIC_APP_API_ENDPOINT}blog/list`)
            .then(response => {
                const fetchedData = response.data.data.blogs.docs.map(item => ({
                    title: item.title,
                    ...
                    action: <Dropdown>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item>
                                <Link
                                    href={{ pathname: "/backend/blog/edit", query: { id: item._id } }}
                                >Edit</Link>
                            </Dropdown.Item>
                                        ...
                                        <div className="card-tools">
                                            <div className="input-group input-group-sm">
                                                ...
                                                <div className="input-group-append">
                                                    <a href="javascript:void(0)" className="btn btn-success" onClick={() => router.push('/backend/blog/create', { scroll: false })}>
