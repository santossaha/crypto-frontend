  ...
  return (
    ...
    <div className="banner-section">
      ...
      <ul>
        ...
        <li>/</li>
        <li><Link href="/blog" className='linkarea'>Blog</Link></li>
        <li>/</li>
        <li>Blog Details</li>
      </ul>
    </div>
                    ...
                    <div className="section-1">
                        <div className="details-area">
                            ...
                            <div className="info-area">
                                ...
                                <h4>The Great Debate: Bitcoin vs. Gold: Analyzing the Diverging Paths of Store of Value Assets in an
Era of Economic Uncertainty, Inflationary Pressures, and Growing Institutional Appetite for
Digital Gold</h4>
<p>
