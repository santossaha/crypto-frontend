          ...
          <div className="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
            <ul className="navbar-nav">
              <li className="nav-item px-md-2">
                <Link className={`nav-link ${isActive('/') ? 'active' : ''}`} aria-current="page" href="/">Home</Link>
              </li>
              <li className="nav-item px-md-2">
                <Link className={`nav-link ${isActive('/about') ? 'active' : ''}`} href="/about">About</Link>
              </li>
              <li className="nav-item px-md-2">
                <Link className={`nav-link ${isActive('/content') ? 'active' : ''}`} href="/content">Content</Link>
              </li>
              <li className="nav-item px-md-2">
                <Link className={`nav-link ${isActive('/service') ? 'active' : ''}`} href="/service">Airdrop</Link>
              </li>
              <li className="nav-item px-md-2">
