          ...
          <div className="row">
            <div className="col-md-4 col-lg-6">
              <div className="info-area area1">
                ...
                <Image className="img" src={p1} alt="logo" />
                </div>
                ...
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                   Iure ea totam quos?</p>
                   <div className="mediaIcon">
                    <ul>
                      <li>
                      <Link className="icon" href="/">
                      <Image className="img" src={m1} alt="s-media" />
                      </Link>
                      </li>
                      <li>
                      <Link className="icon" href="/">
                      <Image className="img" src={m2} alt="logo" />
                      </Link>
                      </li>
                      <li>
                      <Link className="icon" href="/">
                      <Image className="img" src={m3} alt="logo" />
                      </Link>
                      </li>
                    </ul>
                   </div>
